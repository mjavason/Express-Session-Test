...
export const APP_NAME = process.env.APP_NAME || 'Book-Reader-Bot';
export const CORS_ORIGIN = process.env.CORS_ORIGIN || '*';
export const DB_NAME = process.env.MONGO_DB_NAME || 'book-reader-bot';
...
export const SESSION_SECRET = process.env.SESSION_SECRET || 'xxxx';
